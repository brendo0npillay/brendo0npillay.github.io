...
const ScrollExpand = ({
  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      wrap.style.transform = `translate3d(${current.x * followStrength}px, ${current.y * followStrength}px, 0)`;
      ...
      <div ref={trackRef} className="scroll-expand__track">
        <div ref={stageRef} className="scroll-expand__stage">
          <div ref={frameRef} className="scroll-expand__frame">
            <div ref={mediaWrapRef} className="scroll-expand__media-wrap">
              {media}
            </div>
